...
<html>
    <div id="bloc_page">
        <head>
            <!-- En-tête de la page -->
            <link href="css/style_charter.css" rel="stylesheet" />
            <link href="css/style_footer.css" rel="stylesheet" />
            <link rel="icon" type="image/png" href="img/favicon.png" />
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <meta charset="utf-8" />
            <title>green'it - Our charter</title>
        </head>
        ...
        <body>
                ...
                <div class="corpus">
                    <div class='topsection'>
                        <div class='lefttopsection'>
                            <h1>Our charter</h1>
                            <h2>By registering on green'it, organizations commit themselves to respecting our values. Our ambition is to develop a new reference system and to award the green'it label to each organization present on our site.</h2>
                        </div>
                        <div class='imgright'>
                            <img class='contentright' id='logo_charter' src='assets/img/logocharter.png' />
                        </div>
                    </div>
                    <div class='onesubsection inverted'>
                        <div class='left_part'>
                            <h3>Local</h3>
                            <p>At green'it we are in favor of local commerce which favors local jobs and limits the carbon footprint. Local commerce also contributes to the reinforcement of the social link. Far from being purely commercial, the exchanges are above all relational: the shopkeepers are privileged interlocutors, often having in heart to build durable links with their customers; the shops are places of meeting.</p>
                        </div>
                        <div class='imgright'>
                            <img class='contentright' src='assets/img/localoncharter.png' />
                        </div>
                    </div>
                    <div class='onesubsection'>
                        <div class='left_part'>
                            <h3>Transparency</h3>
                            <p>We select organizations that dare to be transparent. Organizations that claim their know-how, that are proud of their work, their products, and their means of production. And who share similar values to green'it. We believe that it is essential to know the story behind each of the organizations' products and services. It is essential to know the origin, the composition and the production method.</p>
                        </div>
                        <div class='imgright'>
                            <img class='contentright' src='assets/img/transparencyoncharter.png' />
                        </div>
                    </div>
                </div>
            </section>
            <footer>
                ...
                <div class='page-container'>
                    ...
                    <ul>
                        <p class='pfootactive'>For organizations</p>
